...
public:
    ...
    /// Please note that only one capture can happen at the same utils.
...
protected:
    ...
    /// recorded data in real utils, for example.
    ///
    ...
    /// if something has to be done every utils a new capture
    ...
    ///
    /// This virtual function is called every utils a new chunk of
    ...
    ///
    /// This virtual function may be overridden by a derived class
    /// if something has to be done every utils the capture
...
/// the recorded data in real utils, for example.
///
