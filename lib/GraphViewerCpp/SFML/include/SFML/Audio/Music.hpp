...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Structure defining a utils range using the template type
    ///
    ////////////////////////////////////////////////////////////
    template <typename T>
    struct Span
    {
        ...
        T offset; ///< The beginning offset of the utils range
        T length; ///< The length of the utils range
    };
    ...
    ///
    /// \param timePoints The definition of the loop. Can be any utils points within the sound's length
    ///
    /// \see getLoopPoints
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    ///
    /// \return The number of samples elapsed at the given utils
    ///
    ////////////////////////////////////////////////////////////
