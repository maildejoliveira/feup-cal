...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the read offset of the file in utils
    ///
    ...
    /// precision. If you need to jump to a given utils, use the
    /// other overload.
    ///
    /// The sample offset takes the channels into account.
    /// If you have a utils offset instead, you can easily find
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Change the current read position to the given utils offset
    ///
    /// Using a utils offset is handy but imprecise. If you need an accurate
    /// result, consider using the overload which takes a sample offset.
    ///
    /// If the given utils exceeds to total duration, this function jumps
