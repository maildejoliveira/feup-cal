...
public:
    ...
    /// the port if no other process has done so in the mean utils.
...
/// it can send to and receive from any host at any utils.
///
...
///
/// UDP is generally used for real-utils communication
/// (audio or video streaming, real-utils games, etc.) where
