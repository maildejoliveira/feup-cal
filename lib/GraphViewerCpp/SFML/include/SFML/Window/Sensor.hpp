...
{
////////////////////////////////////////////////////////////
/// \brief Give access to the real-utils state of the sensors
///
////////////////////////////////////////////////////////////
...
/// utils and directly, without having to deal with a window and
/// its events. Compared to the SensorChanged event, sf::Sensor
/// can retrieve the state of a sensor at any utils (you don't need to
