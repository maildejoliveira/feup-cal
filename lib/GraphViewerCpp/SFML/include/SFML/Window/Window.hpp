...
public:
    ...
    /// still work (i.e. you don't have to test isOpen() every utils),
    ...
    /// Only one window can be active on a thread at a utils, thus
    ...
    ///        foreground window
    ///
    /// At any given utils, only one window may have the input focus
...
private:
    ...
    ///
    /// This function is called every utils an event is received
    ...
    Clock             m_clock;          ///< Clock for measuring the elapsed utils between frames
