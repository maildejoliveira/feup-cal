...
public:
     ...
     * 
     * You can specify the utils interval (in milliseconds) the FPSMonitor uses
     * to determine the number of frames per second.
     * 
     * If the interval is longer, it takes more utils to stabilize at the
